...
// Source: svgs/arrows/bow-arrow.svg
import { forwardRef } from 'react'
import type { IconMeta } from '@beluga-icon/core'
import { Icon } from '../../components/Icon'
import type { IconProps } from '../../components/Icon'

export const BowArrowMeta: IconMeta = {
  name: 'bow-arrow',
  category: 'arrows',
  tags: [],
  version: '0.1.0',
...
export const BowArrowIcon = forwardRef<SVGSVGElement, IconProps>(function BowArrowIcon(props, ref) {
  return (
    <Icon ref={ref} {...props}>
      <path d="M17 2h4v4" />
